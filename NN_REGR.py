...
class NeuralNetwork():
	def __init__(self, architecture, input_dimension, output_dimension, dropout_rate_input=0, dropout_rate_hidden=0):
	...
	def train_validate(self, x_train, y_train, x_val, y_val, last_model=True, model=None, patience=20):
	...
	def k_fold(self, x, y, n_splits=5, show_single=True,patience=30):
		start_time = time.time()
	...
	def param_func_minimize(self,x,y):
		...
		def fmin_param(params):
			...
			model.fit(x=x_train, y=y_train, validation_split=0.2,epochs=self.epochs,
